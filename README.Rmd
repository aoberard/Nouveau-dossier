...
- [`DESCRIPTION`](https://github.com/aoberard/Nouveau dossier/tree/main/DESCRIPTION):
contains project metadata (authors, date, dependencies, etc.)

- [`make.R`](https://github.com/aoberard/Nouveau dossier/tree/main/make.R):
main R script to run the entire project

- [`R/`](https://github.com/aoberard/Nouveau dossier/tree/main/R):
...
Launch the [`make.R`](https://github.com/aoberard/Nouveau dossier/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/aoberard/Nouveau dossier/blob/main/CONTRIBUTING.md).
